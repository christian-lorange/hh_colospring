...
data=readtable('database_working_cospring.xlsx');
...
for i=1:height(data)
    ...
    cards=strcat(s1,char(table2array(data(i,1))),s2,char(table2array(data(i,6))),s2b,char(table2array(data(i,6))),s3,char(table2array(data(i,36))),s4,char(table2array(data(i,37))),s5,char(table2array(data(i,38))),s6,char(table2array(data(i,39))),s7,char(table2array(data(i,40))),s8,char(table2array(data(i,41))),s9,char(table2array(data(i,42))),char(s10a),char(table2array(data(i,21))),char(s10b),char(s10c),s11,'",');
